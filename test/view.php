<?php
	...
	case "add":
		if(!empty($_POST["quantity"])) {
			$productByCode = $db_handle->runQuery("SELECT * FROM registration WHERE code='" . $_GET["code"] . "'");
...
<body>
	...
	<div class="content">
		...
		<div>
				<?php  if (isset($_SESSION['Role'])) : ?>
					<strong>
						<?php echo $_SESSION['Role']['Username']; ?>
	...
	<br>
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM registration ORDER BY id ASC");
	...
	?>
		<div class="product-item">
			...
			<div class="cart-action"><input type="submit" value="submit"/></div>
			</div>
			</form>
		</div>
	<?php
